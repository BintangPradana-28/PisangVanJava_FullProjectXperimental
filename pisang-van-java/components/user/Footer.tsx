    ...
    <footer className="w-full bg-primary text-white pt-16 pb-8 border-t border-white/5">
      <div className="max-w-[1200px] mx-auto px-6">
              ...
              {[
                {
                  name: 'Instagram',
                  href: sanitizeUrl(
                    getSetting('instagram', 'https://instagram.com/pisanggorengvanjava')
                  ),
                  icon: <InstagramIcon />
                },
                {
                  name: 'TikTok',
                  href: sanitizeUrl(
                    getSetting('tiktok', 'https://tiktok.com/@pisanggorengvanjava')
                  ),
                  icon: <TikTokIcon />
                },
                {
                ...
                <li key={item.name}>
                  ...
                  >
                    <span className="text-secondary-container group-hover:text-amber-brand transition-colors duration-200">
                      {item.icon}
                    </span>
                    {item.name}
                  </a>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-cream-50/50">
          <span>
            © {year} Pisang Goreng Van Java. {t('footer_rights')}
          </span>
          <Link
            href="/"
            className="font-sans font-medium tracking-wide hover:text-white transition-colors duration-200"
          >
