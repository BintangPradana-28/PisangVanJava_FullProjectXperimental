...
export const dictionaries: Record<Locale, Translations> = {
  id: {
    ...
    menu_desc_cokelat: "Lelehan cokelat premium yang menyatu sempurna dengan pisang goreng renyah — perpaduan manis pahit yang bikin ketagihan.",
    menu_desc_matcha: "Taburan matcha Jepang asli di atas pisang goreng khas Jawa — fusion unik yang menyegarkan dan elegan.",
    menu_desc_strawberry: "Saus strawberry segar dengan sentuhan manis alami — rasa buah yang menyegarkan di setiap gigitan.",
    menu_desc_blueberry: "Topping blueberry premium dengan rasa asam manis yang seimbang — sensasi buah beri pilihan.",
    menu_desc_taro: "Krim taro ungu lembut dengan aroma khas — kelezatan unik yang jarang ditemukan di tempat lain.",
    menu_desc_tiramisu: "Sentuhan kopi dan mascarpone ala Italia di atas pisang goreng — dessert premium dalam satu gigitan.",
    menu_desc_keju: "Taburan keju cheddar leleh yang gurih — kombinasi asin manis yang selalu jadi favorit pelanggan.",
    menu_desc_susu: "Limpahan susu kental manis yang creamy — rasa klasik yang tidak pernah mengecewakan.",
    menu_desc_original: "Pisang goreng polos tanpa topping — nikmati kerenyahan murni dan manisnya pisang pilihan.",
    menu_desc_milky: "Saus susu creamy dengan rasa lembut — kelezatan klasik yang cocok untuk semua usia.",
    ...
    forgot_email_sent_desc: "Link reset password telah dikirim ke email Anda. Periksa inbox atau folder spam Anda.",
  ...
  en: {
    ...
    menu_desc_cokelat: "Premium melted chocolate perfectly blended with crispy fried banana — an irresistible sweet-bitter combination.",
    menu_desc_matcha: "Authentic Japanese matcha dusted over Javanese fried banana — a refreshing and elegant fusion.",
    menu_desc_strawberry: "Fresh strawberry sauce with a natural sweet touch — a refreshing fruity taste in every bite.",
    menu_desc_blueberry: "Premium blueberry topping with a balanced sweet-tart flavor — a select berry sensation.",
    menu_desc_taro: "Smooth purple taro cream with a distinctive aroma — a unique delicacy rarely found elsewhere.",
    menu_desc_tiramisu: "Italian-style coffee and mascarpone touch on fried banana — a premium dessert in one bite.",
    menu_desc_keju: "Melted cheddar cheese topping — a savory-sweet combo that's always a customer favorite.",
    menu_desc_susu: "Rich condensed milk drizzle — a classic creamy flavor that never disappoints.",
    menu_desc_original: "Plain fried banana without toppings — enjoy the pure crispiness and natural banana sweetness.",
    menu_desc_milky: "Creamy milk sauce with a smooth taste — a classic delight suitable for all ages.",
    menu_filter_all: "All",
